...
- Playground AI – 
- ElevenLabs – TTS, turning books into audiobooks
- Notebook LM – **AMAZING** tool to learn new topics via creating podcasts or video presentations
- Google Live – **AMAZING** aid in learning new enviroments, you can ask it anything about interface and it will help
- local AI – privacy,

# resources
- Hugging Face – library of models, datasets and spaces

# flows
- Comfy UI – flows for graphic AI
- Langflow – flows for LLM-based agents